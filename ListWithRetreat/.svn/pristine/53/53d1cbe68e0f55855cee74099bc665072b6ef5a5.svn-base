...
public class List3<T> extends ListSecondary<T> {
    ...
    private void createNewRep() {
        ...
        this.leftLength = 0;
        this.rightLength = 0;
        this.lastLeft = this.preStart; // TODO not sure
    ...
    public final void addRightFront(T x) {
        ...
        rightNode.data = x;
        this.postFinish.previous.next = rightNode;
        rightNode.previous = this.postFinish.previous;
        rightNode.next = this.postFinish;
        this.postFinish.previous = rightNode;
    ...
    public final T removeRightFront() {
        ...
        this.postFinish.previous = this.postFinish.previous.previous;
        T data = this.postFinish.previous.data;
        this.postFinish.previous.next = this.postFinish;
        assert this.conventionHolds();
        return data;
    }
